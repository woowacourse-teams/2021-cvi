...
class PostControllerTest extends PreprocessPostControllerTest {
    ...
    void createPost() throws Exception {
        //given
        PostResponse expectedResponse = new PostResponse(POST_ID, userResponse, request.getContent(), 0, 0, 0, false, request.getVaccinationType(), LocalDateTime.now(), imageResponses);
    ...
    void find() throws Exception {
        //given
        PostResponse expectedPostResponse = new PostResponse(POST_ID, userResponse, "글 내용", 1, 0, 2, false, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses);
    ...
    void findAll() throws Exception {
        ...
        List<PostResponse> postResponse = new LinkedList<>(Arrays.asList(
                new PostResponse(POST_ID + 1, anotherUserResponse, "글 내용2", 12, 0, 3, false, VaccinationType.MODERNA, LocalDateTime.now(), imageResponses),
                new PostResponse(POST_ID, userResponse, "글 내용1", 55, 5, 13, true, VaccinationType.PFIZER, LocalDateTime.now().minusDays(1L), imageResponses)
        ));
    ...
    void findByVaccineType() throws Exception {
        //given
        List<PostResponse> postResponse = new LinkedList<>(Arrays.asList(
                new PostResponse(3L, userResponse, "이건 내용입니다.", 100, 10, 4, true, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses),
                new PostResponse(2L, userResponse, "이건 내용입니다.2", 200, 20, 6, false, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses),
                new PostResponse(1L, userResponse, "이건 내용입니다.3", 300, 30, 10, true, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses)
        ));
        willReturn(postResponse).given(postService).findByVaccineType(any(VaccinationType.class), any());
        //when
    ...
    void findByVaccineTypePaging() throws Exception {
        ...
        List<PostResponse> postResponses = new LinkedList<>(Arrays.asList(
                new PostResponse(38L, userResponse, "이건 내용입니다.", 100, 10, 3, true, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses),
                new PostResponse(37L, userResponse, "이건 내용입니다.2", 200, 20, 4, false, VaccinationType.PFIZER, LocalDateTime.now().minusDays(1), imageResponses),
                new PostResponse(36L, userResponse, "이건 내용입니다.3", 300, 30, 2, true, VaccinationType.PFIZER, LocalDateTime.now().minusDays(2), imageResponses)
        ));
    ...
    void findByVaccineTypeSorting() throws Exception {
        //given
        List<PostResponse> postResponses = new LinkedList<>(Arrays.asList(
                new PostResponse(1L, userResponse, "이건 내용입니다.", 100, 10, 5, true, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses),
                new PostResponse(37L, userResponse, "이건 내용입니다.2", 200, 20, 8, false, VaccinationType.PFIZER, LocalDateTime.now().minusDays(1), imageResponses),
                new PostResponse(146L, userResponse, "이건 내용입니다.3", 300, 30, 1, true, VaccinationType.PFIZER, LocalDateTime.now().minusDays(2), imageResponses)
        ));
        willReturn(postResponses).given(postService).findByVaccineType(any(VaccinationType.class), anyInt(), anyInt(), any(), anyInt(), any());
        //when
    ...
    void findByVaccineTypeHourFiltering() throws Exception {
        //given
        List<PostResponse> postResponses = new LinkedList<>(Arrays.asList(
                new PostResponse(1L, userResponse, "이건 내용입니다.", 100, 10, 3, true, VaccinationType.PFIZER, LocalDateTime.now(), imageResponses),
                new PostResponse(37L, userResponse, "이건 내용입니다.2", 200, 20, 6, false, VaccinationType.PFIZER, LocalDateTime.now().minusHours(3), imageResponses),
                new PostResponse(146L, userResponse, "이건 내용입니다.3", 300, 30, 7, true, VaccinationType.PFIZER, LocalDateTime.now().minusHours(5), imageResponses)
        ));
        willReturn(postResponses).given(postService).findByVaccineType(any(VaccinationType.class), anyInt(), anyInt(), any(), anyInt(), any());
        //when
