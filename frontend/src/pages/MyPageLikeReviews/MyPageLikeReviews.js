...
import { Container, Title, MyReviewList, MyReview } from './MyPageLikeReviews.styles';

const MyPageLikeReviews = () => {
...
export default MyPageLikeReviews;
