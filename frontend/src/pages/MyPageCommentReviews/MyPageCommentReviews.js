...
import { Container, Title, MyReviewList, MyReview } from './MyPageCommentReviews.styles';

const MyPageCommentReviews = () => {
...
export default MyPageCommentReviews;
